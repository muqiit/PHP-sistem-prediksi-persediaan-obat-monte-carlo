                ...
                <div class="box">
                    ...
                    <div class="card-body table-responsive p-0" style="height: 450px;">
                        <table class="table table-head-fixed text-nowrap">
                            ...
                            {
                              $cari = $_POST['cari'];
                              $a=mysqli_query($connect,"SELECT a.kd_hasil_pre, b.kd_pakai, b.kd_obat, d.jenis_obat, d.nama_obat, c.jumlah_obat, sum(a.hasil) as jumlah_hasil , d.tahun FROM tbl_hasil_prediksi a, tbl_pakai b, vw_jml_obat c, tbl_obat d WHERE a.kd_pakai=b.kd_pakai and a.kd_obat=c.kd_obat and a.kd_obat=d.kd_obat and d.tahun like '%".$cari."%' GROUP BY a.kd_obat");
